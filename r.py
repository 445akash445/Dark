...
Buy From :- @a4x_Crypto
Official Channel :- https://t.me/joinnnnn4x
'''
...
def welcome_start(message):
    ...
    response = f'''👋🏻Welcome to A4x DARK DDOS 🚀, {user_name}! SASTA HAI KHARID LO ABHI .
🤖Try To Run This Command : /help 
✅Join :- https://t.me/joinnnnn4x'''
    bot.reply_to(message, response)
